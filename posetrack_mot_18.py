...
class PoseTrackMOT(_BaseDataset):
    ...
    def get_default_dataset_config():
        ...
        default_config = {
            ...
            'TRACKERS_FOLDER': os.path.join(code_path, '/home/dobbang/jeon/4dhumans/trackers_18/'),  # Trackers location
            'PRINT_CONFIG': True,
    ...
    def __init__(self, config=None):
        ...
        for seq in self.seq_list:
            ...
            curr_file = os.path.join(self.gt_fol, seq, 'gt/gt_sampling_18.txt')
    ...
    def _get_seq_info(self):
        ...
        for seq in seq_list:
            config_file = os.path.join(self.gt_fol, seq, 'image_info_18.json')
            if not os.path.isfile(config_file):
                raise TrackEvalException('image info file does not exist: ' + seq + '/image_info_18.json')
    ...
    def _load_raw_file(self, tracker, seq, is_gt):
        ...
        if is_gt:
            ...
            file = os.path.join(self.gt_fol, seq, 'gt/gt_sampling_18.txt')
        else:
